                                    ...
                                    unsigned char message )
{
    ...
    switch( level )
    {
        ...
        case MBEDTLS_SSL_ALERT_LEVEL_WARNING:
            ...
            mbedtls_mps_write( ssl->mps, MBEDTLS_MPS_PORT_ALERT );
                                       ...
                                       mbedtls_mps_handshake_in **dst )
{
    ...
    *dst = NULL;
    ...
    ret = mbedtls_mps_read( ssl->mps );
    if( ret < 0 )
    {
        MBEDTLS_SSL_DEBUG_RET( 1, "mbedtls_mps_read", ret );
        return( ret );
    }
                                       ...
                                       mbedtls_mps_handshake_in *msg )
{
    ...
    /* Fetch content */
    ret = mbedtls_reader_get( msg->reader,
    ...
    mbedtls_reader_commit( msg->reader,
