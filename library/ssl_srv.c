...
static int ssl_process_server_hello_write      ( mbedtls_ssl_context const *ssl,
                                                 unsigned char* buf,
                                                 size_t buflen,
                                                 size_t *olen );
...
static int ssl_process_server_hello( mbedtls_ssl_context *ssl )
{
     ...
     * For the MPS, that corresponds to attempting to open a write-port. */
    ...
    /* NOTE: For the MPS, the postprocessing step might
     *       come after the dispatching step if the latter
...
static int ssl_process_server_hello_preprocess( mbedtls_ssl_context *ssl )
{
    ...
    /* Gather random bytes
       TODO: This should be done much earlier, e.g. at handshake_init   */
