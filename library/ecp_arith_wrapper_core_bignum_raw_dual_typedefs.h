...
#ifndef MBEDTLS_ECP_ARITH_WRAPPER_CORE_BIGNUM_RAW_DUAL_TYPEDEFS_H
#define MBEDTLS_ECP_ARITH_WRAPPER_CORE_BIGNUM_RAW_DUAL_TYPEDEFS_H
...
#endif /* MBEDTLS_ECP_ARITH_WRAPPER_CORE_BIGNUM_RAW_DUAL_TYPEDEFS_H */
