 ...
 *
 * \param X        The destination MPI. Must point to an initialized MPI.
 * \param radix    The numberic base of the input string. Must be between
 *                 \c 2 and \c 16.
 ...
 * \param radix    The numeric base of the output string. Must be
 *                 between \c 2 and \c 16.
 ...
 *                 in the source line. Must be between \c 2 and \c 16.
 ...
 *                 printing in base 16.
 * \param X        The source MPI.
 * \param radix    The numeric base to be used in the emitted string.
 *                 Must be between \c 2 and \c 16.
 ...
 *                 Must be between \c 0 and #MBEDTLS_MPI_MAX_BITS.
