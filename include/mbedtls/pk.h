 ...
 *                      PK_RSA converts to PK_RSASSA_PSS which has uses
 *                      different padding scheme for signatures.
 *
 * \return          0 if \c from is convertible to \c to, nonzero otherwise.
 *
 */
int mbedtls_pk_type_convertible( mbedtls_pk_type_t from, mbedtls_pk_type_t to );
 ...
 *                  the same result as the function \c mbedtls_pk_type_convertible. 
